 ...
 * tsh - Shell
 *
 * Luiz Paulo Martos - nUSP 5635122
 * Petrus Gomes - nUSP 
 * Vinícius Fioramonte - nUSP 5726537
 */
...
char prompt[] = "A18> ";			/* prompt de comando (NAO MUDE ISSO) */
...
void eval(char *cmdline)
{
	...
	if (pid) {
		...
		if (execvp((char *) argv[0], (char **) &argv)) {
			fprintf(stderr,
 ...
 * handler elimina todas os filhos zumbis, mas nao espera outros
 * filhos terminarem.
 */
void sigchld_handler(int sig)
{
