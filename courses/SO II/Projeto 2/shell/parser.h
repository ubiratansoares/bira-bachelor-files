...
/* This is where we store the command line data. */

typedef struct command_line_t command_line_t;
struct command_line_t
{
  int argc;    /* Number of arguments (including the command). */
  char **argv; /* Command line in argv format. */   
};
