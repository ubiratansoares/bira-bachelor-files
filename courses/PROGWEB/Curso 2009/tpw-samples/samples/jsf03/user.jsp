...
<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<h:form id="user">
		<tr><td class="campocentral"><h:outputText value="#{msg.name}"/>
				<h:inputText value="#{user.name}" required="true"/></td></tr>
		<tr><td class="campocentral"><h:outputText value="#{msg.login}"/>
				<h:inputText value="#{user.login}" required="true"/></td></tr>
		<tr><td class="campocentral"><h:outputText value="#{msg.passwd}"/>
				<h:inputText value="#{user.passwd}" required="true"/></td></tr>
		<tr><td>&nbsp;</td></tr>
		<tr><td class="campocentral"><h:commandButton value="#{msg.insert}" 
