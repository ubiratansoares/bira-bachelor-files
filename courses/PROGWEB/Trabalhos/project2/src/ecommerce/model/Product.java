...
public class Product {
	...
	public Product() {
		...
		this.purchase_items = new HashSet<PurchaseItem>();
	}
	
	
	
	@OneToMany(mappedBy="product")
	private Set<PurchaseItem> purchase_items; //stats
	
	@Transient
	private Long amount_sold;
	...
	/**
	 * Define os itens de compra que se referem a este produto.
	 */
	private void setPurchaseItems(Set<PurchaseItem> items) {
	 ...
	 */
	private void setAmountSold(Long amount) {
	...
	/**
	 * Constrói um nome de exibição a partir do nome do produto,
	 * da marca e do modelo.
	 */
	public String getHeading() {
		String text = (name == null)? "": name;
		text += (brand == null)? "": " " + brand;
		text += (model == null)? "": " " + model;
		return text.trim();
	}
